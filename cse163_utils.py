...
This module contains the assert_equals function (and associated functions
necessary for it) that we use for some testing functions. This module was
kindly provided by the teachers and TAs of the University of Washington's
CSE163 class.
"""
